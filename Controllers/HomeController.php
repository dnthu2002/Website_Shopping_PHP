...
class HomeController
{
    ...
    function list()
    {
        // $data_danhmuc = $this->home_model->category();
        ...
        $data_limit1 = $this->home_model->limit(0,12);
        $count_sold = $this->home_model->count_sold();
        $best_seller=$this->home_model->best_seller();
        $rating_pro=$this->home_model->ranting_pro();
        $banner=$this->home_model->banner();
