                        ...
                        <div class="col-sm-7">
                            <div class="contact-info">
                                ...
                                <ul class="contact-list">
                                    <li>
                                        <i class="far fa-map-marker"></i> 70 Washington Square South New York, NY 10012, United States
                                    </li>
                                    <li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7 col-xl-6">
                                    <div class="store-content">
                                        ...
                                        <a href="#" class="btn btn-link" target="_blank"><span>View Map</span><i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                    <!-- End .store-content -->
                                </div>
                                <!-- End .col-xl-6 -->
