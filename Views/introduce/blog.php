...
<main class="main">
    <div class="intro-slider-container1 mb-3 mb-lg-5"></div>
                        ...
                        <ul class="pagination">
                            <li class="page-item disabled">
                                <a class="page-link page-link-prev" href="#" aria-label="Previous" tabindex="-1" aria-disabled="true">
                                    <span aria-hidden="true"><i class="far fa-long-arrow-left"></i></span>Prev
                                </a>
                            </li>
                            ...
                            <li class="page-item">
                                <a class="page-link page-link-next" href="#" aria-label="Next">
							                Next <span aria-hidden="true"><i class="far fa-long-arrow-right"></i></span>
							            </a>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <div class="sidebar">
                        <div class="widget widget-search">
                            ...
                            <form action="#">
                                ...
                                <button type="submit" class="btn"><i class="far fa-search"></i><span class="sr-only">Search</span></button>
                            </form>
                        </div>
                        <!-- End .widget -->
